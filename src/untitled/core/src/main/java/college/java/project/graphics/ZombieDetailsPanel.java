...
public final class ZombieDetailsPanel extends Group {
    ...
    public ZombieDetailsPanel(Skin skin, GameAssetManager assets, ZombieAnimationCatalog animationCatalog) {
        ...
        this.toughnessValue = label("", 0.85f, Align.left);
        this.speedValue = label("", 0.85f, Align.left);
        this.descriptionLabel = label("", 0.70f, Align.topLeft);
        this.featureLabel = label("", 0.65f, Align.topLeft);
        this.identityLabel = label("", 0.58f, Align.topLeft);
        this.combatLabel = label("", 0.58f, Align.topLeft);
        this.armorLabel = label("", 0.55f, Align.topLeft);
        this.resistanceLabel = label("", 0.55f, Align.topLeft);
        this.nameLabel.setColor(PvzVisualTheme.TEXT_CREAM);
        this.toughnessValue.setColor(PvzVisualTheme.TEXT_CREAM);
        this.speedValue.setColor(PvzVisualTheme.TEXT_CREAM);
        this.descriptionLabel.setColor(PvzVisualTheme.TEXT_CREAM);
        this.featureLabel.setColor(PvzVisualTheme.TEXT_CREAM);
        this.identityLabel.setColor(PvzVisualTheme.TEXT_CREAM);
        this.combatLabel.setColor(PvzVisualTheme.TEXT_CREAM);
        this.armorLabel.setColor(PvzVisualTheme.TEXT_CREAM);
        this.resistanceLabel.setColor(PvzVisualTheme.TEXT_CREAM);
