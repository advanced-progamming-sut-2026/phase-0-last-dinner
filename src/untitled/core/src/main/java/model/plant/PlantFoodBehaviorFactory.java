...
final class PlantFoodBehaviorFactory {
    ...
    PlantFoodBehavior create(PlantDefinition definition) {
        ...
        PlantFoodBehavior behavior = this.createAvailabilityFood(definition, name, effect);
        if (behavior == null) {
            behavior = this.createSimpleAttackFood(definition, name);
        }
        if (behavior == null) {
            behavior = this.createConditionFood(definition, name);
        }
        if (behavior == null) {
            behavior = this.createTargetFood(definition, name);
        }
        if (behavior == null) {
            behavior = this.createLobberOrMeleeFood(definition, name);
        }
        if (behavior == null) {
            behavior = this.createDefenderFood(definition, name);
        }
        if (behavior == null) {
            behavior = this.createSupportFood(definition, name);
        }
        return behavior == null ? this.createShooterOrDefaultFood(definition, name, effect) : behavior;
    }
    private PlantFoodBehavior createAvailabilityFood(PlantDefinition definition, String name, String effect) {
    ...
    private PlantFoodBehavior createSimpleAttackFood(PlantDefinition definition, String name) {
    ...
    private PlantFoodBehavior createConditionFood(PlantDefinition definition, String name) {
    ...
    private PlantFoodBehavior createTargetFood(PlantDefinition definition, String name) {
    ...
    private PlantFoodBehavior createLobberOrMeleeFood(PlantDefinition definition, String name) {
    ...
    private PlantFoodBehavior createDefenderFood(PlantDefinition definition, String name) {
    ...
    private PlantFoodBehavior createSupportFood(PlantDefinition definition, String name) {
    ...
    private PlantFoodBehavior createShooterOrDefaultFood(
